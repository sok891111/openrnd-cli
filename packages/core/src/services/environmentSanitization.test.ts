...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe (fake test values for sanitization testing)
      STRIPE_SK_LIVE: 'sk_live_FAKE_TEST_VALUE_FOR_TESTING',
      STRIPE_RK_LIVE: 'rk_live_FAKE_TEST_VALUE_FOR_TESTING',
      STRIPE_SK_TEST: 'sk_test_FAKE_TEST_VALUE_FOR_TESTING',
      STRIPE_RK_TEST: 'rk_test_FAKE_TEST_VALUE_FOR_TESTING',
      // Slack
