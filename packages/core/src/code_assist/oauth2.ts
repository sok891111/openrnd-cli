...
// Set GEMINI_OAUTH_CLIENT_ID environment variable to override.
const OAUTH_CLIENT_ID =
  process.env['GEMINI_OAUTH_CLIENT_ID'] ??
  '681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
// For installed applications this is not a secret per Google's documentation:
// https://developers.google.com/identity/protocols/oauth2#installed
// Set GEMINI_OAUTH_CLIENT_SECRET environment variable to override.
const OAUTH_CLIENT_SECRET =
  process.env['GEMINI_OAUTH_CLIENT_SECRET'] ?? 'GOCSPX-PLACEHOLDER-SET-ENV-VAR';
