  ...
  llm: {
    ...
    properties: {
      baseUrl: {
        ...
        default: undefined as string | undefined,
        description:
          'Base URL for the OpenAI-compatible API endpoint. Example: https://api.openai.com/v1 or http://localhost:11434/v1',
        showInDialog: false,
      },
      model: {
        type: 'string',
        ...
        default: undefined as string | undefined,
        description:
          'Model name to use. Example: gpt-4o, llama3.2, claude-3-5-sonnet.',
        showInDialog: false,
      },
      apiKey: {
        type: 'string',
